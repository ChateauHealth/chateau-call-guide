...
<head>
    ...
    <title>Chateau Health & Wellness Call System Guide</title>
    <!-- Tailwind CSS CDN -->
    ...
    <style>
        ...
        summary {
            ...
            background-color: #f1f5f9; /* Lighter background for summary */
        ...
        /* Custom styles for smaller bullet points */
        .list-circle li::before {
            content: "•"; /* Use a simple dot */
            color: #64748b; /* A darker gray for contrast */
            display: inline-block; /* Required for the content property to work */
            width: 1em; /* Space before the text */
            margin-left: -1em; /* Pull the dot left to align text */
            font-size: 1.2em; /* Make the dot slightly larger */
    ...
    <main class="space-y-8">
        ...
        <details class="rounded-xl shadow-md overflow-hidden">
            ...
            <div class="content-body">
                ...
                <h3 class="text-lg font-semibold text-gray-800 mb-2">First Attendant (CallRail)</h3>
